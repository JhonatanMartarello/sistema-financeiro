...
import com.financeiro.sistema.processar_arquivo.arquivos.FcaCiaAbertaEscrituradorFacade;
    ...
    public void lerArquivoCsv(String nomeArquivo) {
        ...
        try {
            ...
            if (FCA_CIA_ABERTA_GERAL.equals(nomeArquivo)) {
                ...
                List<FcaCiaAbertaValorMobiliarioBean> beans = new CsvToBeanBuilder(new FileReader(pathArquivo))
                ...
                List<FcaCiaAbertaEscrituradorBean> beans = new CsvToBeanBuilder(new FileReader(pathArquivo))
